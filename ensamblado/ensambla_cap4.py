...
def main():
    ...
    course = """    const courseData = {
      ...
      modules: [
        ...
        { id: 6, title: "Definición de estratos", shortTitle: "Definir estratos", duration: "26 min" },
        { id: 7, title: "Un modelo para el estratificado", shortTitle: "Modelo", duration: "22 min" },
