    ...
    const BANCO_TALLER1 = [
...

      {
        ...
        ancla: { cap: 1, modulo: 4, titulo: 'Sesgo de selección', lohr: '1.3–1.4' },
        alto: 220,
        descripcionGrafico: 'Distribución de la estatura en el marco completo de 2 000 personas y en el conjunto de 1 300 respondientes, las dos en proporción, con las dos medias marcadas con rectas verticales. Entre 140 y 170 cm las barras de los respondientes son más bajas que las del marco, y de 170 cm en adelante son más altas; la recta de la media de los respondientes queda a la derecha de la del marco.',
...

      {
        ...
        ancla: { cap: 2, modulo: 7, titulo: 'Determinación del tamaño de muestra', lohr: '2.4–2.5' },
        alto: 220,
        descripcionGrafico: 'Margen de error al 95 % para la estatura media en función del tamaño de muestra, con y sin corrección por población finita, sobre una población de 2 000 personas. La curva sin corrección es naranja y discontinua y la de con corrección verde y continua; las dos arrancan casi juntas en n = 25, en 4,37 y 4,35 cm, pasan por 2,2 y 2,1 cm en n = 100 y por 0,98 y 0,85 cm en n = 500, y en n = 2 000 la naranja se queda en 0,49 cm mientras la verde llega a 0.',
