    ...
    AUTOEVALUACIONES['cap4'] = [
      ...
      },
      {
        ...
        retroAcierto: 'Las tres primeras son compromisos: renuncian a ser óptimas para una variable a cambio de no ser malas para ninguna. La cuarta es el mismo error con la camiseta cambiada — sería óptima para <code>farms92</code> y mala para <code>acres92</code>, que es exactamente el problema del enunciado.',
        retroFallo: 'La falsa es la última: cambiar de variable favorita no resuelve nada, solo elige otra víctima. Las otras tres son las dos familias de compromiso del módulo, y la de la potencia llega a ganarle a la proporcional en las dos varas a la vez.'
      },
      {
        tipo: 'opcion',
        modulo: 10,
      ...
      },
      {
        ...
        retroAcierto: 'Las tres verdaderas son la regla del módulo: hacen falta los $t_{xh}$, <em>y</em> $n_h$ holgados, <em>y</em> razones que de verdad cambien entre estratos. Aquí falla la segunda. La cuarta es la trampa: más información no es automáticamente menos error cuando esa información se usa con estimadores sesgados.',
        retroFallo: 'La falsa es la última. La simulación del módulo la desmiente con datos: con 3 por estrato el error cuadrático medio de la separada es 7,195 % contra 3,734 % de la combinada. Aprovechar más información y hacerlo mejor no son lo mismo.'
      },
      {
        tipo: 'numerica',
        modulo: 2,
