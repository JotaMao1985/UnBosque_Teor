    ...
    AUTOEVALUACIONES['cap2'] = [
      ...
      },
      {
        ...
        retroAcierto: 'Todas menos la del «siempre más preciso». El sistemático es un diseño de dos caras: sobre <code>agpop</code> ordenado por <code>acres87</code> el DEFF es 0,073, y con un orden cíclico patológico sube a 218,9.',
        retroFallo: 'Las otras tres son ciertas; la del «siempre más preciso» no. Todo depende del orden del marco: el mismo diseño puede tener DEFF 0,073 o 218,9 sobre la misma población.'
      },
      {
        tipo: 'opcion',
        modulo: 10,
