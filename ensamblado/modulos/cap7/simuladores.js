    ...
    GLOSARIOS['complejas'] = {
      ...
      filas: [
        ...
        { concepto: 'Grados de libertad', aqui: '\\text{PSU} - H', lohr: 'n - H', gutierrez: 'N - H', r: 'degf(dis)' },
        { concepto: 'Efecto de diseño', aqui: '\\text{deff}', lohr: '\\text{deff}', gutierrez: 'DEFF', r: 'svymean(deff = TRUE)' },
        { concepto: 'deff solo por pesos', aqui: '\\text{deff}_{K}', lohr: '1 + CV_w^2', gutierrez: '—', r: '1 + var(w)/mean(w)^2' },
        { concepto: 'Tamaño efectivo', aqui: 'n_{ef}', lohr: 'n_{\\text{eff}} = n/\\text{deff}', gutierrez: '—', r: 'nrow(d)/deff(m)' },
        { concepto: 'Razón poblacional', aqui: 'B = t_y/t_x', lohr: 'B', gutierrez: 'B', r: 'coef(svyratio())' },
        { concepto: 'Variable linealizada', aqui: 'u_k', lohr: 'q_i', gutierrez: 'u_k', r: '(y - B*x)/Xhat' },
        { concepto: 'Réplica jackknife', aqui: '\\hat\\theta_{(hi)}', lohr: '\\hat\\theta_{(j)}', gutierrez: '—', r: 'as.svrepdesign(type="JKn")' },
        { concepto: 'Post-estratificación', aqui: 'g_k', lohr: 'w_i^{*}', gutierrez: 'g_{ks}', r: 'postStratify()' },
    ...
    AUTOEVALUACIONES['cap7'] = [
      ...
      },
      {
        tipo: 'numerica',
        modulo: 6,
        pregunta: 'En el IPFP del módulo 6 el error máximo cae así: $1{,}3\\times10^{-1}$, $3{,}35\\times10^{-3}$, $4{,}54\\times10^{-6}$, $6{,}15\\times10^{-9}$, $8{,}33\\times10^{-12}$. De la segunda iteración en adelante, el cociente entre un error y el siguiente es constante: ese es el ritmo del algoritmo. ¿Cuánto vale? Entero.',
        pista: 'Divide $3{,}35\\times10^{-3}$ entre $4{,}54\\times10^{-6}$, y compruébalo con el par siguiente: tiene que salir lo mismo. El primer cociente, el que arranca en $0{,}13$, no cuenta.',
        respuesta: 738,
        tolerancia: 25,
        retroAcierto: 'Y los dos pares siguientes vuelven a dar 738: eso es convergencia geométrica, el error se divide por una constante en cada paso. Por eso 3 iteraciones bastan para cualquier publicación y 6 dejan el error en $2\\times10^{-16}$, que es el suelo de la máquina: de ahí ya no baja por mucho que se itere.',
        retroFallo: 'El primer paso engaña: $0{,}13 / 3{,}35\\times10^{-3} \\approx 39$, y eso no es el ritmo del algoritmo sino lo que cuesta salir de una tabla de partida cualquiera. El ritmo propio aparece en la segunda iteración y ya no se mueve: 738, 738, 738.'
      },
      {
        tipo: 'grafico',
        modulo: 3,
